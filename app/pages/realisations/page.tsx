...
export default function RealisationsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative h-[80vh] min-h-[500px] bg-gray-900">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl space-y-8 transform transition-all duration-700 ease-out">
            {/* Titre avec effet de dégradé et ombre portée */}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-amber-400 via-orange-500 to-amber-300 animate-gradient-x">
              Nos Réalisations
            </h1>
            
            {/* Séparateur décoratif */}
            <div className="w-24 h-1.5 bg-gradient-to-r from-amber-400 to-orange-500 mx-auto rounded-full shadow-lg" />
            
            {/* Texte avec animation subtile */}
            <div className="backdrop-blur-sm bg-black/30 p-6 rounded-2xl border border-white/10 shadow-2xl transform transition-all hover:scale-105 duration-500">
          ...
          <div className="flex mt-4 flex-col sm:flex-row justify-center gap-4">
            <a 
              href="#nos-projets" 
